  ...
  theme: {
    extend: {
      colors: {
        ...
        "rh-cyan-light": "var(--rh-cyan-light)",
        "rh-orange-light": "var(--rh-orange-light)",
        "rh-pink-light": "var(--rh-pink-light)",
        "rh-pink-dark": "var(--rh-pink-dark)",
        "rh-purple-light": "var(--rh-purple-light)",      },
      borderRadius: {
