    ...
    <div className="space-y-4">
      ...
      <Surface className="p-4 space-y-3">
        <div className="flex items-start justify-between gap-3">
          <div>
            <p className="text-xs text-black/60">Your night in pixels</p>
            <h3 className="mt-1 text-sm font-semibold text-black">
              We auto-cut every set so you might be in from last night.
            </h3>
          </div>
          <Chip className="bg-rh-pink-light/15 border-rh-pink-light/30 text-[11px] text-black">
            Warehouse Eclipse
          </Chip>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3 text-center text-xs">
          <div>
            <p className="text-2xl font-semibold text-black">47</p>
            <p className="text-black/60">Photos found</p>
          </div>
          <div>
            <p className="text-2xl font-semibold text-black">6</p>
            <p className="text-black/60">Clips with you</p>
          </div>
          <div>
            <p className="text-2xl font-semibold text-black">3</p>
            <p className="text-black/60">Polaroids scanned</p>
          </div>
        </div>
        ...
        <button disabled className="w-full rounded-full bg-black/10 px-3 py-1.5 text-[11px] text-black/80 hover:bg-black/15 disabled:opacity-50 disabled:cursor-not-allowed">
      ...
      {/* Story-sized reels */}
      <Surface className="p-4 space-y-3">
        <p className="text-xs text-black/60">Story-sized reels</p>
        ...
        <div className="relative mt-2 h-32 w-full overflow-hidden rounded-2xl bg-black/60">
          ...
          <div className="absolute left-3 right-3 top-3 flex flex-wrap gap-2 text-[10px]">
            <Chip className="bg-rh-cyan/20 border-rh-cyan/40 text-black">Techno marathon</Chip>
            <Chip className="bg-rh-purple/20 border-rh-purple/40 text-black">
              House on the Strip
            </Chip>
          </div>
      ...
      {/* Photographer wall */}
      <Surface className="p-4 space-y-3">
        <p className="text-xs text-black/60">Photographer wall</p>
        <h3 className="text-sm font-semibold text-black">
        ...
        <div className="space-y-2 text-xs text-black/80">
          <div className="flex items-center justify-between">
            <span>@nightnado</span>
            <span className="text-black/60">27 sets</span>
          </div>
          <div className="flex items-center justify-between">
            <span>@laserfiends</span>
            <span className="text-black/60">14 sets</span>
          </div>
          <div className="flex items-center justify-between">
            <span>@filmgrain</span>
            <span className="text-black/60">9 sets</span>
          </div>
        </div>
